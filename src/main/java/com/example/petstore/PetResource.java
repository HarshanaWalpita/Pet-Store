...
public class PetResource { 
	...
	@POST
	@Path("addOnePet/{id}/{age}/{name}/{type}")
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "200", description = "Start", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(ref = "Pet"))) })
	@GET
	@Path("start")
	public Response addInitialPets() {
		...
		pet4.setPetId(4);
		pet4.setPetAge(1);
		pet4.setPetName("Jerry");
		pet4.setPetType("Mouse");
